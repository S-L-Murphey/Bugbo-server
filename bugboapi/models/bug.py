...
class Bug(models.Model):
    ...
    status = models.ForeignKey("BugStatus", default=4, on_delete=models.CASCADE)
    ...
    owner = models.ForeignKey("Employee", default= 4, on_delete=models.CASCADE, related_name='owner')
